# src/models/train_all_vol_lr.py
# Train Ridge per decile and produce WALK-FORWARD *volatility* predictions (LR version).
...
def main():
    ...
    print(f"Found {len(files)} feature files for VOL LR training:")
    for f in files:
        print(" -", f)
